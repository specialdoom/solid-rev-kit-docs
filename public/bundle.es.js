  ...
  if (t === "string" || t === "number") {
    ...
    if (array.length === 0) {
      ...
      if (Array.isArray(current)) {
        ...
        reconcileArrays$1(parent, multi && current || [parent.firstChild], array);
      }
    }
    current = array;
...
let e$1={data:""},t$1=t=>"object"==typeof window?((t?t.querySelector("#_goober"):window._goober)||Object.assign((t||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:t||e$1,l$1=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,a$1=/\/\*[^]*?\*\/|\s\s+|\n/g,n$1=(e,t)=>{let r="",l="",a="";for(let o in e){let s=e[o];"@"==o[0]?"i"==o[1]?r=o+" "+s+";":l+="f"==o[1]?n$1(s,o):o+"{"+n$1(s,"k"==o[1]?"":t)+"}":"object"==typeof s?l+=n$1(s,t?t.replace(/([^,])+/g,e=>o.replace(/(^:.*)|([^,])+/g,t=>/&/.test(t)?t.replace(/&/g,e):e?e+" "+t:t)):o):null!=s&&(o=o.replace(/[A-Z]/g,"-$&").toLowerCase(),a+=n$1.p?n$1.p(o,s):o+":"+s+";");}return r+(t&&a?t+"{"+a+"}":a)+l},o$1={},s$1=e=>{if("object"==typeof e){let t="";for(let r in e)t+=r+s$1(e[r]);return t}return e},c$1=(e,t,r,c,i)=>{let u=s$1(e),p=o$1[u]||(o$1[u]=(e=>{let t=0,r=11;for(;t<e.length;)r=101*r+e.charCodeAt(t++)>>>0;return "go"+r})(u));if(!o$1[p]){let t=u!==e?e:(e=>{let t,r=[{}];for(;t=l$1.exec(e.replace(a$1,""));)t[4]?r.shift():t[3]?r.unshift(r[0][t[3]]=r[0][t[3]]||{}):r[0][t[1]]=t[2];return r[0]})(e);o$1[p]=n$1(i?{["@keyframes "+p]:t}:t,r?"":"."+p);}return ((e,t,r)=>{-1==t.data.indexOf(e)&&(t.data=r?e+t.data:t.data+e);})(o$1[p],t,c),p},i$1=(e,t,r)=>e.reduce((e,l,a)=>{let o=t[a];if(o&&o.call){let e=o(r),t=e&&e.props&&e.props.className||/^go/.test(e)&&e;o=t?"."+t:e&&"object"==typeof e?e.props?"":n$1(e,""):!1===e?"":e;}return e+l+(null==o?"":o)},"");function u$1(e){let r=this||{},l=e.call?e(r.p):e;return c$1(l.unshift?l.raw?i$1(l,[].slice.call(arguments,1),r.p):l.reduce((e,t)=>Object.assign(e,t&&t.call?t(r.p):t),{}):l,t$1(r.target),r.g,r.o,r.k)}u$1.bind({g:1});u$1.bind({k:1});
...
function styled$1(tag) {
  ...
  return (...args) => {
    ...
    Styled.className = props => {
      return untrack(() => {
        return u$1.apply({ target: _ctx.target, p: props, g: _ctx.g }, args);
      });
    };
    return Styled;
  };
...
function createGlobalStyles() {
  const fn = styled$1.call({ g: 1 }, "div").apply(null, arguments);
...
const StyledHeading = styled$1('h1')`
...
const StyledParagraph = styled$1('p')`
...
const StyledAlert = styled$1('div')`
...
const StyledAvatar$1 = styled$1('div')`
	height: 56px;
  width: 56px;
  display: flex;
...
const StyledAvatar = styled$1('div')`
	height: 56px;
	width: 56px;
	border-radius: ${props => props.round ? '50%' : '4px'};
...
const StyledSmallCallout = styled$1('div')`
	width: 100%;
	height: 80%;
	display: inline-flex;
	justify-content: space-between;
...
`;
const ActionsContainer$1 = styled$1('div')`
	display: inline-flex;
	justify-content: ${props => props.small ? 'flex-end' : 'flex-start'};
	align-items: center;
	gap: 8px;
`;
const StyledLargeCallout = styled$1('div')`
	width: 100%;
	height: auto;
	min-height: 200px;
	padding: 40px;
...
const StyledCard$1 = styled$1('div')`
	height: fit-content;
  width: 300px;
  padding: 16px;
  box-sizing: border-box;
...
const Image = styled$1('div')`
  ...
  width: 100%;
`;
const ActionsContainer = styled$1('div')`
  padding: 8px 0;
  height: auto;
  font-size: 14px;
`;
const BodyContainer = styled$1('div')`
  height: auto;
  font-size: 14px;
  padding: 8px 0;
`;
...
const StyledSpinner = styled$1('div')`
  ...
  get children() {
    return createComponent(For, {
      ...
      children: type => (() => {
        ...
        insert(_el$, createComponent(Paragraph, {
          type: type,
        ...
        insert(_el$, createComponent(Label, {
          type: type,
          children: "Label"
        }), null);
...
const App = () => {
  return (() => {
    ...
    insert(_el$, createComponent(Legend, {
      title: "Colors",
      rank: 2
    }), null);

    insert(_el$, createComponent(ColorsSection, {}), null);
    ...
    insert(_el$, createComponent(IconsSection, {}), null);
    ...
    insert(_el$, createComponent(ButtonsSection, {}), null);
    ...
    insert(_el$, createComponent(AvatarsSection, {}), null);
    ...
    insert(_el$, createComponent(TypeScaleSection, {}), null);
    ...
    insert(_el$, createComponent(CardsSection, {}), null);
    ...
    insert(_el$, createComponent(AlertsSection, {}), null);
    ...
    insert(_el$, createComponent(CalloutsSection, {}), null);
