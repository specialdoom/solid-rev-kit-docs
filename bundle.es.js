...
const _tmpl$$3 = template(`<label></label>`),
      _tmpl$2$1$1 = template(`<h2></h2>`),
      _tmpl$3 = template(`<p></p>`);
const {
  More: More$2
} = Icons;
...
const _tmpl$$5 = template(`<input type="checkbox">`),
...
const _tmpl$$1 = template$1(`<span>Aa</span>`),
      _tmpl$2$1 = template$1(`<br>`);
    ...
    return [createComponent(Card.Fill, {
      ...
      get children() {
        return [createComponent(Typography.Label, {
          ...
          get children() {
            return ["Regular", _tmpl$2$1.cloneNode(true), "Aa Bb Cc Dd Ee Ff Gg Hh Ii Jj Kk Ll Mm Nn Oo Pp Qq Rr Ss Tt Uu Vv Ww Xx Yy Zz"];
          }
          ...
          get children() {
            return ["SemiBold", _tmpl$2$1.cloneNode(true), "Aa Bb Cc Dd Ee Ff Gg Hh Ii Jj Kk Ll Mm Nn Oo Pp Qq Rr Ss Tt Uu Vv Ww Xx Yy Zz"];
          }
...
const App = () => {
  return (() => {
    ...
    insert$1(_el$, createComponent(TypefaceSection, {}), null);
