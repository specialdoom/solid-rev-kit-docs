...
const _tmpl$$3 = template$1(`<div></div>`);
...
const _tmpl$$2 = template$1(`<span>Aa</span>`),
      _tmpl$2$2 = template$1(`<br>`);
...
const _tmpl$$1 = template$1(`<span>bright top tooltip (mouseenter)</span>`),
      _tmpl$2$1 = template$1(`<span>bright bottom tooltip (click)</span>`),
      _tmpl$3 = template$1(`<span>bright left tooltip (click)</span>`),
      _tmpl$4 = template$1(`<span>bright right tooltip (mouseenter)</span>`),
      _tmpl$5 = template$1(`<span>accent top tooltip (mouseenter)</span>`),
      _tmpl$6 = template$1(`<span>accent bottom tooltip (click)</span>`),
      _tmpl$7 = template$1(`<span>accent left tooltip (click)</span>`),
      _tmpl$8 = template$1(`<span>accent right tooltip (mouseenter)</span>`),
      _tmpl$9 = template$1(`<span>success top tooltip (mouseenter)</span>`),
      _tmpl$10 = template$1(`<span>success bottom tooltip (click)</span>`),
      _tmpl$11 = template$1(`<span>success left tooltip (click)</span>`),
      _tmpl$12 = template$1(`<span>success right tooltip (mouseenter)</span>`),
      _tmpl$13 = template$1(`<span>error top tooltip (mouseenter)</span>`),
      _tmpl$14 = template$1(`<span>error bottom tooltip (click)</span>`),
      _tmpl$15 = template$1(`<span>error left tooltip (click)</span>`),
      _tmpl$16 = template$1(`<span>error right tooltip (mouseenter)</span>`),
      _tmpl$17 = template$1(`<span>warning top tooltip (mouseenter)</span>`),
      _tmpl$18 = template$1(`<span>warning bottom tooltip (click)</span>`),
      _tmpl$19 = template$1(`<span>warning left tooltip (focus)</span>`),
      _tmpl$20 = template$1(`<span>warning right tooltip (mouseenter)</span>`),
      _tmpl$21 = template$1(`<span>dark top tooltip (mouseenter)</span>`),
      _tmpl$22 = template$1(`<span>dark bottom tooltip (click)</span>`),
      _tmpl$23 = template$1(`<span>dark left tooltip (click)</span>`),
      _tmpl$24 = template$1(`<span>dark right tooltip (mouseenter)</span>`);
